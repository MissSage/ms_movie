...
// import vertex from '@/utils/three/shader/gradColor/vertex.glsl'
// import fragment from '@/utils/three/shader/gradColor/fragment.glsl'

export function gradColor(mesh: any) {
  // console.log(mesh);
  // 传递unfiorm变量
