...
import { GLMeshBuilder } from '../core/WebGLMesh'
...
export class MD5SkinedMesh {
  ...
  public drawSkeleton(clrBuilder: GLMeshBuilder, mvp: mat4): void {
    ...
    for (let i = 0; i < this.joints.length - 1; i++) {
      ...
      clrBuilder
        .color(1, 0, 0)
        .vertex(joint.originInModelSpace.x, joint.originInModelSpace.y, joint.originInModelSpace.z)
      clrBuilder
        .color(1, 0, 0)
        .vertex(
          joint2.originInModelSpace.x,
          joint2.originInModelSpace.y,
          joint2.originInModelSpace.z,
        )
    }
    clrBuilder.end(mvp)
    clrBuilder.unbind()
