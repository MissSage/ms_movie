import { vec2, vec3, vec4 } from '../common/math/TSM'
import { GLAttribBits, GLAttribState } from '../core/WebGLAttribState'
...
export class Cube {
  ...
  public constructor(halfWidth = 0.2, halfHeight = 0.2, halfDepth = 0.2) {
...
export class GridPlane {
  ...
  public constructor(sx = 10, sy = 10, nx = 10, ny = 10) {
    this.sx = sx
    this.sy = sy
    this.nx = nx
    this.ny = ny
