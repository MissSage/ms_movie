...
export class MathHelper {
  ...
  public static boundBoxClear(mins: vec3, maxs: vec3, value = Infinity): void {
  ...
  public static boundBoxGet8Points(mins: vec3, maxs: vec3, pts8: vec3[]): void {
    ...
    pts8.push(
      new vec3([center.x + maxs2center.x, center.y + maxs2center.y, center.z + maxs2center.z]),
    ) // 0
    pts8.push(
      new vec3([center.x + maxs2center.x, center.y - maxs2center.y, center.z + maxs2center.z]),
    ) // 1
  ...
  public static convertVec3IDCoord2GLCoord(v: vec3, scale = 10.0): void {
