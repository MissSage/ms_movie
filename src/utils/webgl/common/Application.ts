...
export class CanvasInputEvent {
  ...
  // 构造函数，使用了default参数
  public constructor(type: EInputEventType, altKey = false, ctrlKey = false, shiftKey = false) {
    this.altKey = altKey
...
class Timer {
  ...
  public countdown = 0 // 倒计时器，每次update时会倒计时
  public timeout = 0 //
...
export class Application implements EventListenerObject {
  ...
  protected _isRightMouseDown = false // 为了支持鼠标按下drag事件
