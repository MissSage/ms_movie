...
export class GLTexture {
  ...
  public constructor(gl: WebGLRenderingContext, name = '') {
    this.gl = gl
    this.isMipmap = false
  ...
  public filter(minLinear = true, magLinear = true): void {
  ...
  public upload(source: HTMLImageElement | HTMLCanvasElement, unit = 0, mipmap = false): void {
