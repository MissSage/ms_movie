...
import { GLHelper, EShaderType, GLUniformMap, GLAttribMap } from '../core/WebGLHepler'
...
export class BasicWebGLApplication extends Application {
  ...
  public makeViewportCoordSystems(num = 3): GLCoordSystem[] {
