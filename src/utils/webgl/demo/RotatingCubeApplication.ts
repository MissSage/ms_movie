import { GLProgram } from '../core/WebGLProgram'
import { GLTexture } from '../core/WebGLTexture'
import { GLStaticMesh } from '../core/WebGLMesh'
import { CameraApplication } from '../lib/CameraApplication'
import { vec3, mat4 } from '../common/math/TSM'
import { HttpRequest } from '../common/utils/HttpRequest'
import { GLTextureCache } from '../core/WebGLTextureCache'
import { GLProgramCache } from '../core/WebGLProgramCache'
...
export class RotatingCubeApplication extends CameraApplication {
  ...
  private _renderText(text: string, x: number = this.canvas.width * 0.5, y = 150): void {
    if (this.ctx2D !== null) {
  ...
  public drawText(pos: vec3, axis: EAxisType, mvp: mat4, inverse = false): void {
    if (this.ctx2D === null) {
      return
    }
