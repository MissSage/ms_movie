<template>
  <ElContainer>
    <el-menu :mode="'vertical'" class="el-menu-vertical-demo" :collapse="store.layout.collapse" :router="true"
    ...
    <el-container>
      <el-header>
        ...
        <div class="header-wrapper">
          ...
          <Icon :title="store.layout.collapse ? '展开菜单' : '折叠菜单'" class="hamburger"
            :class="{ collapse: store.layout.collapse }" @click="store.layout.Toggle_Collapse" icon="quill:hamburger">
          </Icon>
        </div>
      </el-header>
      <el-main>
