  ...
  <div>
    ...
    >
      ...
      <el-form-item label="主演">
        <el-input
          v-model="movie.starrings.newStarring.value"
          placeholder="请输入"
        >
          <template #append>
      ...
      <el-form-item label="平台">
        <el-input
          v-model="movie.platforms.newPlatForm.value"
          placeholder="请输入"
        >
          <template #append>
      ...
      <el-form-item label="">
        <el-checkbox-group
          v-model="movie.types.curTypes.value"
          @change="movie.setMovieTypes"
        >
          <el-checkbox
            v-for="tag in movie.types.typeList.value"
            :key="tag._id"
            :label="tag.name"
          />
        </el-checkbox-group>
      ...
      <el-form-item label="">
        <el-checkbox-group
          v-model="movie.tags.curTags.value"
          @change="movie.setMovieTags"
        >
          <el-checkbox
