<template>
  <div class="box">
    ...
    <fc-typing-input></fc-typing-input>
    <fc-bubbles Click active="true">
      <fc-china></fc-china>
    </fc-bubbles>
  </div>
</template>
<script lang="ts" setup>
import { FcTypingInput, FcChina, FcBubbles, FcWaveFilter, FcWarpBtn, Fc3DBtn, FcArrowBtn, FcUnderlineBtn, FcPixelBtn, FcDblWarpBtn, FcParenthesesBtn, FcRoundBtn } from "fancy-components"
new FcChina()
new FcBubbles()
new FcWaveFilter()
new FcWarpBtn()
new Fc3DBtn("fc-three")
new FcArrowBtn()
new FcUnderlineBtn()
new FcPixelBtn()
new FcDblWarpBtn()
